...
import type { HolidayCategoryOption } from '../../types/holidays';
    ...
    <div class="flex flex-col gap-3 rounded-xl border border-zinc-200 bg-white p-4 shadow-xs dark:border-zinc-800 dark:bg-zinc-900 sm:flex-row sm:items-center sm:justify-between">
        <div class="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center">
            <div class="w-full sm:max-w-xs">
                <SearchInput :model-value="search" placeholder="Search holidays..." @update:model-value="onSearch" />
            </div>
        ...
        <div class="flex items-center gap-2 text-xs text-zinc-500">
            <span>Showing {{ totalCount }} holidays</span>
