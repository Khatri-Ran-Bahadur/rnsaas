...
const initialFeatureIds = (props.plan.features || []).map((f) => f.id);
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <div class="flex items-center gap-3">
                            ...
                            <Badge :variant="form.is_active ? 'active' : 'suspended'" />
                        </div>
                        <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
                            Update pricing, billing terms, trial periods, and included module features.
                        </p>
                    </div>
                </div>
