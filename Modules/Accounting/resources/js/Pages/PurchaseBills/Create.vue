...
const submit = () => {
    ...
    form.post('/admin/accounting/purchase-bills', {
        preserveScroll: true,
    });
};
</script>
...
<template>
    ...
    >
        <Head title="New Purchase Bill - Accounting" />
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-1">
                        Record a supplier invoice with line items, tax breakdown, and expense account allocations.
                    </p>
                </div>

                <Link href="/admin/accounting/purchase-bills">
            ...
            <form class="space-y-6" @submit.prevent="submit">
                                ...
                                <tr v-for="(line, index) in lines" :key="index" class="align-top">
                                    ...
                                    <td class="py-3 pr-2">
                                        <input
                                            ...
                                            type="text"
                                            required
                                            placeholder="Item description or expense item..."
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div class="rounded-xl border border-zinc-200 bg-white p-6 shadow-xs dark:border-zinc-800 dark:bg-zinc-900">
                        ...
                        <textarea
                            v-model="form.notes"
                            rows="4"
                            placeholder="Add memo or internal reference details..."
                ...
                <div class="flex items-center justify-end gap-3">
                    ...
                    <Button type="submit" variant="primary" :disabled="form.processing">
                        {{ form.processing ? 'Creating...' : 'Save Draft Bill' }}
                    </Button>
                </div>
            </form>
        </div>
